<?php
  ...
  if (function_exists('add_theme_support')) {
    ...
    function get_social_url(){
        ...
        $size_social             = ot_get_option(THEME_PREFIX . '_social_network_size','30');

        echo"<ul>";
        foreach($social_networks as $social) {
            $social_url = ot_get_option(THEME_PREFIX . '_social_network_' . $social['id']);
            if($social_url) {
                ?>

            <li>
                <a href="<?php echo $social_url; ?>" class="tzsocialfont size<?php echo $size_social; ?> fa fa-<?php echo $social['id']; ?>"></a>
            </li>
    ...
    function tzcheck_social(){
        ...
        if(empty($tz_social_arr)){
            ...
            $social_class['class'] = "tzsocialnone";
        }else{
            $social_class['class_sp'] = $span_social;
            $social_class['class'] = $tzsocialclass;
        }
        return $social_class;
    }
