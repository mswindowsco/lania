...
<?php get_header(); ?>
<?php load_template( trailingslashit( SERVER_PATH ) . 'inc/page-breadcrumb.php' ); ?>
...
<div class="row-fluid product">
	...
	<div class="span4" id="single_image" style="display:inline;height:inherit !important;">
		...
		<img style="max-width:75%; max-height:200px ;margin:auto;display:block;vertical-align: middle;border: 5px solid white; -webkit-box-shadow: 0px 5px 2px 0px rgba(50, 50, 50, 0.69); -moz-box-shadow:    0px 5px 2px 0px rgba(50, 50, 50, 0.69); box-shadow:         0px 5px 2px 0px rgba(50, 50, 50, 0.69);
...
<section class="about_web">
 ...
 <section class="about_web">
            <div class="container-fluid bk-gray2"  style="border-top: 1px solid #E9E9E9; border-top-width: 1px; border-top-style: solid; border-top-color: rgb(233, 233, 233);">
                <div class="full-width">
...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
 ...
 <section class="about_web">
            <div class="container-fluid bk-white"  style="border-top: 1px solid #E9E9E9; border-top-width: 1px; border-top-style: solid; border-top-color: rgb(233, 233, 233);">
                <div class="full-width">
