                            ...
                            ?>
                                    ...
                                    ?>
                                        <div class="blog-content-heading">
                                            <?php if($Blog_images=='show'): the_post_thumbnail(); endif; ?>
                                            <h3 class="blog-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
                                            <?php if($Blog_Info=='show'): ?>
                                                <div class="blog-info">
                                                    <span>
                                                        by
                                            ...
                                            <?php endif; ?>
                                            <?php if($Blog_Excerpt=='show'): ?>
                                                <div class="blog-description">
                                                   <?php the_excerpt(); ?>
                                                </div>
                                            <?php endif; ?>
                                            <?php if(isset($termsTag) && $termsTag !=false && $Blog_Tags=='show'): ?>
                                                <div class="blog-tags">
                                                    Tags:
                                                    <?php
                            ...
                            <?php }else{ ?>
                                    ...
                                    if($type=='quote'){
                                        ...
                                        <div class="blog-content-item">
                                            ...
                                            <div class="blog-description">
                                                <h3 class="blog-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
                                                <?php if($Blog_Excerpt=='show'): the_excerpt(); endif; ?>
                                            </div>
